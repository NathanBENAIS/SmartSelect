// Toast Manager Component (toastManager.js)
class ToastManager {
    constructor() {
    ...
    createToast(type, message) {
        ...
        toast.className = `flex items-center w-full max-w-xs p-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800 transition-all transform translate-x-full`;
        toast.innerHTML = `
